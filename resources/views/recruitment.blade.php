    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 img-plan">
                <img src="{{ asset("{{ asset(") }}" ./images/rec.jpg") }}" alt="" class="rounded w-75"
                    class="img-fluid">
            </div>
            <div class="col-lg-7  programme-loop">
                <div class="content-dawrat">
                    <form onsubmit="sendEmail(); reset(); return false;" class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="titleinitiative" class="form-label"> رقم الجوال </label>
                        ...
                        <div class="col-md-6">
                            <label for="optioninitiative" class="form-label"> اسم الوظيفة</label>
